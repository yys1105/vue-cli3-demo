...
<template>
  <div>
        ...
        <div class="account">
          ...
          <div class="main">
            ...
            <div class="value">
                ...
                <el-button size="small" type="primary" style="margin-left:20px;">提现</el-button>
                ...
                <el-popover
                  ...
                  <div class="pop">
                    ...
                    <div>
                      1、1万以下（含1万）手续费5元；<br>
                      2、1-10万（含10万）手续费10元；<br>
                      3、10-50万（含50万）手续费15元；<br>
                      4、50-100万（含100万）手续费20元；<br>
                      5、100-1000万（含1000万）按0.00002比率计算算；<br>
                      6、大于1000万手续费200元；<br>
                    </div>
          ...
          <div class="operation">
            <el-button type="text">查看提现记录</el-button>
          </div>
        </div>
      ...
      <div class="content">
        <search-panel :searchParams.sync="searchParams" :searchOption="searchOption" @search="search"></search-panel>
        <table-e :datas="tableData.list" :counts='tableData.count' name="accountRetrieve" storeName="accountRetrieve" :headers="headers"></table-e>
      </div>
  </div>
</template>
